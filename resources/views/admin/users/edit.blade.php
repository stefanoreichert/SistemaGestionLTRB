        ...
        <div style="display:flex;align-items:center;gap:.875rem;">
            <a href="{{ route('admin.users.index') }}"
               style="color:#6b7280;text-decoration:none;font-size:.78rem;padding:.3rem .65rem;
                      border:1px solid #2a2a2a;border-radius:.5rem;">&#8592; Usuarios</a>
            <span style="font-size:1rem;font-weight:800;color:#fbbf24;">Editar Usuario</span>
        </div>
    </x-slot>
    <div style="padding:.75rem 1rem;max-width:32rem;">
